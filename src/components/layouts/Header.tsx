...
export function Header() {
  return (
    ...
    >
      ...
      <div className="absolute right-3 top-3 z-20 flex items-center gap-1.5 rounded-full bg-[var(--color-text-on-primary)]/10 px-2 py-1.5 backdrop-blur-md sm:right-4 sm:top-4 sm:gap-2 sm:px-3 sm:py-2 md:right-6 md:top-6 md:gap-3">
        <LanguageSwitcher />
        <ThemeSwitcher />
      </div>

      <div className="relative z-10 flex flex-col items-start px-2 text-center sm:px-4">
        ...
        <p className="mt-1 text-sm font-medium text-[var(--color-text-on-primary)]/90 drop-shadow-md sm:mt-2 sm:text-base md:text-lg lg:text-xl">

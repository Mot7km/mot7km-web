...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link
      href={href}
      prefetch={false}
      className="group flex flex-col w-full max-h-[240px]
    ...
    >
      {/* Image container */}
      <div className="relative w-full h-25 bg-[var(--color-card-light)] dark:bg-[var(--color-card-dark)] overflow-hidden flex-shrink-0">
        <Image
          src={product.image}
          alt={product.name}
          fill

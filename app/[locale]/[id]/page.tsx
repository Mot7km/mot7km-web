...
import { ReviewsContainer } from '@/components/common/ReviewsContainer';
        ...
        <div className="bg-[var(--color-surface)] rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-5 sm:p-6 md:p-8 space-y-5 md:space-y-6">
            ...
            <div className="flex flex-col gap-2">
              {/* Row: Name + Price (desktop/tablet: inline, mobile: stacked) */}
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-3">
                ...
                {/* Price – on mobile: plain text; on sm and up: badge */}
